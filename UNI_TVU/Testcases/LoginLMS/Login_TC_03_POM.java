...
//extend: ke thua
public class Login_TC_03_POM extends AbstractTest {
	...
	public void TC_03_Vaolop_MoTaiLieu_GiaoTrinh() {
		/*
		 * open home Lop hoc lay bien lopHocAction để hứng giá trị khi click button
		 * LopHoc tren trang home ham openLophocpage: được viết ở HomeActions
		 */
		 ...
		 * LopHoc tren trang home ham openLophocpage: được viết ở HomeActions
		 */
		pageHDSD = lopHocAction.openPageTaiLieu(driver,AbstractPageUI.DYNAMIC_LINK_TAILIEU,"http://eldata1.topica.edu.vn:82/images/UIUX/pdf.png");
	}
